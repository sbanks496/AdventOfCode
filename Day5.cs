...
public class Day5
{
    ...
    public static void Part2()
    {
        ...
        foreach (string line in lines)
        {
            ...
            {
                string[] instructions = line.Split(' ');
                int x = int.Parse(instructions[1]);
                input[int.Parse(instructions[5])].InsertRange(0, input[int.Parse(instructions[3])].GetRange(0,x));
                input[int.Parse(instructions[3])].RemoveRange(0,x);
            }
        }
